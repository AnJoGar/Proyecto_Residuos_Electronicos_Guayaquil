...
def k_fold_validation(X_scaled, y, n_splits=5):
...
def main():
    ...
    mse_kfold, r2_kfold = k_fold_validation(X_scaled, y)
    print(f"K-Fold Cross Validation - MSE promedio: {np.mean(mse_kfold):.4f}, R² promedio: {np.mean(r2_kfold):.4f}")
